...
> = {
  "ai-policy-clients-cannot-see": {
    ...
    excerpt: "More than half of corporate legal and tax departments want the firms they hire to use AI. Fewer than a third know whether those firms actually do. And 40% of firms report receiving conflicting client instructions about AI use. An internal policy that never reaches a client does nothing about any of that.",
    image: "/blog/mostly-not-visible.png",
    content: (
      <>
        <div className="my-12 flex justify-center">
          <Image
            src="/blog/mostly-not-visible.png"
            alt="Half Your Clients Want You Using AI. Fewer Than a Third Know Whether You Are."
            width={1200}
            height={800}
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Policy Has the Wrong Reader</h2>
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">Adoption Was Never the Bottleneck</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">Why the Banned Tools List Ages So Badly</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">Write the Kind That Survives</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Record Is the Part That Gets Skipped</h2>
        <p className="mt-4 text-justify">
  ...
  "ai-document-extraction-accuracy-claims": {
    title: "Everyone Selling Document AI Reports 97% Accuracy. None of Them Mean the Same Thing.",
    category: "AI",
    date: "3 September, 2026",
    readTime: "4 min read",
    gradient: "from-ai-blue to-ai-peach",
    excerpt: "Published benchmarks for AI document extraction cluster around 97% for header fields, 95 to 99% once validation is added, and straight-through processing rates anywhere from 60% to 92%. Every one of those figures comes from a company selling the software, and they are not measuring the same thing. One vendor concedes the part that matters: most exceptions are not extraction failures.",
    image: "/blog/same-number-different-thing.png",
    content: (
      <>
        <div className="my-12 flex justify-center">
          <Image
            src="/blog/same-number-different-thing.png"
            alt="Everyone Selling Document AI Reports 97% Accuracy. None of Them Mean the Same Thing."
            width={1200}
            height={800}
            className="rounded-lg shadow-lg w-full max-w-5xl h-auto"
          />
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">Four Numbers, Four Different Questions</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Concession Buried in the Marketing</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Number Nobody Publishes</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">What to Ask For in a Demo</h2>
        <p className="mt-4 text-justify">
  ...
  "agentic-ai-assumes-a-workflow": {
    title: "Agentic AI Assumes a Workflow. Only 30% of Firms Have One.",
    category: "AI",
    date: "2 September, 2026",
    readTime: "4 min read",
    gradient: "from-ai-blue to-ai-mint",
    excerpt: "Eighty-eight percent of accountants now use AI for at least one client service, and 75% say the tools delivered more value than expected. Only 30% have AI fully embedded as their default. The gap between those numbers is the whole reason agentic AI keeps stalling in firms that are otherwise enthusiastic about it.",
    image: "/blog/situational-versus-embedded.png",
    content: (
      <>
        <div className="my-12 flex justify-center">
          <Image
            src="/blog/situational-versus-embedded.png"
            alt="Agentic AI Assumes a Workflow. Only 30% of Firms Have One."
            width={1200}
            height={800}
            className="rounded-lg shadow-lg w-full max-w-5xl h-auto"
          />
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">Situational Use Is Not a Small Version of Embedded Use</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">What Agentic Actually Requires</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Precondition Nobody Costs</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Honest Sequence</h2>
        <p className="mt-4 text-justify">
  ...
  "ai-audit-evidence-technology-assisted": {
    title: "AI Can Test Every Transaction. The New Standard Asks a Different Question.",
    category: "AI",
    date: "1 September, 2026",
    readTime: "4 min read",
    gradient: "from-ai-blue to-ai-cyan",
    excerpt: "The PCAOB amendments to AS 1105 and AS 2301 are effective for audits of financial statements for fiscal years beginning on or after 15 December 2025, which means the calendar-2026 audits being planned right now. They specify what an auditor owes when a tool processes the evidence, and coverage is not on the list.",
    image: "/blog/population-and-exceptions.png",
    content: (
      <>
        <div className="my-12 flex justify-center">
          <Image
            src="/blog/population-and-exceptions.png"
            alt="AI Can Test Every Transaction. The New Standard Asks a Different Question."
            width={1200}
            height={800}
            className="rounded-lg shadow-lg w-full max-w-5xl h-auto"
          />
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Pitch and the Standard Point in Different Directions</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">Coverage Is the Cheap Part</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Regulator Sees the Tension Too</h2>
        <p className="mt-4 text-justify">
        ...
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">What This Actually Asks of an Engagement</h2>
        <p className="mt-4 text-justify">
  ...
  "irs-ai-audit-selection-126": {
    title: "The IRS Ran 10 AI Use Cases in 2022. It Now Runs 126.",
    category: "AI",
    date: "31 August, 2026",
    readTime: "4 min read",
    gradient: "from-ai-violet to-ai-mint",
    excerpt: "The GAO reported in March that the IRS held 126 active AI use cases as of June 2025, against 10 in August 2022. Sixty-one percent were still in development, and 65 of the 126 were too sensitive to report publicly. Meanwhile the IRS workforce fell about 25% in a year. Selection is scaling. Examination is not.",
    image: "/blog/unseen-rule.png",
    content: (
      <>
        <div className="my-12 flex justify-center">
          <Image
            src="/blog/unseen-rule.png"
            alt="The IRS Ran 10 AI Use Cases in 2022. It Now Runs 126."
            width={1200}
            height={800}
            className="rounded-lg shadow-lg w-full max-w-5xl h-auto"
          />
        ...
        <p className="text-xl text-foreground text-justify">
          On 24 March 2026 the Government Accountability Office published GAO-26-107522, an assessment of how the IRS uses artificial intelligence. One number in it does most of the work.
        </p>
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">What the Inventory Actually Says</h2>
        <p className="mt-4 text-justify">
          The IRS held 126 active AI use cases in its inventory as of June 2025. In August 2022 it reported 10.
        </p>
        <p className="mt-4 text-justify">
          Two details in the same report matter more than the headline count, and both cut against reading it as a finished capability.
        </p>
        <p className="mt-4 text-justify">
          Sixty-one percent of the use cases, 77 of the 126, were listed as still in development in June 2025. And 65 of the 126 were either too sensitive for public reporting or were research and development efforts exempt from it.
        </p>
        <p className="mt-4 text-justify">
          So the public inventory is roughly half the picture, and more than half of what is in it had not shipped. Anyone telling you the IRS has a finished AI audit machine is overstating the report. Anyone telling you this is early-stage experimentation is understating a twelvefold increase in three years.
        </p>
        <p className="mt-4 text-justify">
          The report itself is titled around gaps, not triumphs: skills gaps, information quality and strategic management. GAO noted that officials in the Research, Applied Analytics and Statistics group had lost 63 employees who had been working on AI full or part time.
        </p>
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">Selection Got Cheaper. Examination Did Not.</h2>
        <p className="mt-4 text-justify">
          Set that against staffing. The IRS workforce fell roughly 25% over the year to mid-2025.
        </p>
        <p className="mt-4 text-justify">
          Those two facts pull in opposite directions and the combination is the actual story. Building a model that ranks returns by risk is a fixed cost paid once. Examining a return is a variable cost paid in trained hours, and trained hours got scarcer.
        </p>
        <p className="mt-4 text-justify">
          The rational response to that constraint is exactly what the inventory shows: spend on selection, so that the examinations you can still afford land on the returns most likely to justify them.
        </p>
        <p className="mt-4 text-justify">
          For a firm, that reframes the practical question. It was never really about the odds. It is now about what happens in the weeks after a return is flagged, because a model-selected examination arrives already pointed at something specific.
        </p>
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">The Bias Finding, Stated Plainly</h2>
        <p className="mt-4 text-justify">
          There is a caveat here that deserves to be reported rather than skipped.
        </p>
        <p className="mt-4 text-justify">
          GAO has flagged the potential for unintentional algorithmic bias in return selection, on the straightforward mechanism that a model trained on historical selections inherits whatever was in them. Independent studies cited by GAO found Black taxpayers audited at three to five times the rate of others. GAO has called for better documentation and transparency around the IRS use of AI.
        </p>
        <p className="mt-4 text-justify">
          That is a serious finding about a public system, and it is a reason to want the documentation GAO asked for. It is not a reason to assume a particular client was flagged wrongly. Both things are true at once, and a firm advising a selected client has to hold them separately.
        </p>
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">What Actually Protects a Position</h2>
        <p className="mt-4 text-justify">
          If selection is model-driven and examinations are fewer and better aimed, the defensible position is the one that can be supported quickly.
        </p>
        <p className="mt-4 text-justify">
          The mechanics of that are unglamorous. When a notice arrives about a specific line, the firm needs the source documents behind it, the reason the position was taken, and the correspondence around it, in the time the notice allows rather than in the time it would take to reconstruct three years of filing decisions.
        </p>
        <p className="mt-4 text-justify">
          That is where most of the cost of an examination actually sits for a small firm. Not in the technical argument, which is usually straightforward, but in assembling the evidence for an argument nobody expected to have to make about a return that was filed correctly.
        </p>
        <p className="mt-4 text-justify">
          MetaWurks works on that half. It ingests a client&apos;s returns, statements, invoices, contracts and correspondence and lets an accountant query the whole set in plain English, so establishing what supports a particular figure is a question rather than an excavation across a portal, a drive and an inbox. Role based access controls decide who can open which client&apos;s records, audit logs record who opened what and when, and documents ingested into the platform are not used to train models or exposed to other users.
        </p>
        <p className="mt-4 text-justify">
          It has no view on how a return was selected, and no software does. What it changes is the speed of the answer once the letter is on the desk.
        </p>
        <p className="mt-4 text-justify">
          The IRS went from 10 use cases to 126 while losing a quarter of its people. Read the second half of that sentence as carefully as the first.
        </p>
        <h2 className="text-3xl font-display font-bold tracking-tight mb-4 mt-8 text-foreground">Join the Conversation</h2>
        <p className="text-justify">
          If a client received a notice next week questioning one figure on a return you filed in 2024, how long would it take to put the supporting documents in front of them?
        </p>
      </>
    ),
  },
