...
import Logo from "./MetaWurks Logo-11.svg";
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-7 gap-12 mb-16 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col">
            <Link href="/" onClick={handleLinkClick} className="mb-6 self-start">
              <Image 
                src={Logo} 
                alt="MetaWurks" 
            ...
            <div className="flex gap-4">
              {[
                { icon: Twitter, href: "https://x.com/Metawurks_ai" },
                { icon: Instagram, href: "http://instagram.com/metawurks/" },
