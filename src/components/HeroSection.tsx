    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Headline */}
          <h1 
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold leading-[0.95] tracking-tight mb-6 opacity-0 animate-fade-in"
          ...
          >
            <div className="relative aspect-[16/9] max-w-4xl mx-auto">
              {/* Central node */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full bg-gradient-to-br from-ai-blue via-ai-violet to-ai-peach animate-pulse-soft shadow-2xl glow-effect flex items-center justify-center">
              ...
              {[
                ...
                { top: "15%", left: "70%", color: "from-ai-violet to-ai-peach", label: "Claude", delay: 1 },
                ...
                { top: "40%", left: "5%", color: "from-ai-mint to-ai-violet", label: "Mistral", delay: 1.5 },
                { top: "35%", left: "90%", color: "from-ai-blue to-ai-violet", label: "Cohere", delay: 2.5 },
              ].map((node, i) => (
                <div 
                  key={i}
